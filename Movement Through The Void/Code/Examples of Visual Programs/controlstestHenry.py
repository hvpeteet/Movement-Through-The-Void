...
bl = button(pos=(-40,30), height=20, width=20, text='Left', action=lambda: setdir(-1))
br = button(pos=(-20,30), height=20, width=20, text='Right', action=lambda: setdir(1))
bscale=button(pos=(30,30),height=20,width=20,text="new",action=lambda:setsize(1))
bscaleneg=button(pos=(50,30),height=20,width=20,text="anti-New",action=lambda:setsize(-1))
